...
const modalStyles = {
	modal:
		"absolute top-0 right-0 w-[350px] md:w-[500px] h-fit m-4 p-2 flex flex-col rounded-xl bg-dark-1 bg-opacity-20 backdrop-blur-lg border border-dark-1 border-opacity-40 shadow-2xl shadow-black z-[9999] duration-500 ease-in-out",
